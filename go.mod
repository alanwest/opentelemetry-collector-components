...
require (
	github.com/newrelic/opentelemetry-collector-components/connector/apmconnector v0.0.0-00010101000000-000000000000
	github.com/newrelic/opentelemetry-collector-components/processor/apmprocessor v0.0.0-00010101000000-000000000000
